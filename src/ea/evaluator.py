...
class Nsga2: 
    ...
    def nsga2_evaluator_threaded(self, fitness_function, fitness_function_args, fitness_function_kargs, fitness_values, A_set, index, k,G, no_obj,time_gen_values,thread_lock, args, thread_id) :
