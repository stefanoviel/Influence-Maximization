...
for indicator in r:
    ...
    name_graph = 'facebook_combined' 
    filenames = ['facebook_combined_WC_8_MAPPING.csv', 'facebook_combined_WC_4_MAPPING.csv', 'facebook_combined_WC_2_MAPPING.csv','facebook_combined_IC_8_MAPPING.csv','facebook_combined_IC_4_MAPPING.csv','facebook_combined_IC_2_MAPPING.csv']
