...
for subd in os.listdir('result_comparison'): 
    ...
    # Make the plot
    plt.bar(br1, df_new.loc[df_new["fitness_function"] == "I.F."]["hypervolume values"], color ='r', width = barWidth,
            edgecolor ='grey', label ='base')
    plt.bar(br2, df_new.loc[df_new["fitness_function"] == "I.S.C."]["hypervolume values"], color ='b', width = barWidth,
            edgecolor ='grey', label ='communities')
    plt.bar(br3, df_new.loc[df_new["fitness_function"] == "I.S.T."]["hypervolume values"], color ='g', width = barWidth,
            edgecolor ='grey', label ='time')
    plt.bar(br4, df_new.loc[df_new["fitness_function"] == "I.S.C.T."]["hypervolume values"], color ='yellow', width = barWidth,
            edgecolor ='grey', label ='#communities & time')

    # Adding std
    plt.errorbar(x = br1, y = df_new.loc[df_new["fitness_function"] == "I.F."]["hypervolume values"], 
        yerr=df_new.loc[df_new["fitness_function"] == "I.F."]['hypervolume std'], fmt='none', c= 'black', capsize = 2)
    plt.errorbar(x = br2, y = df_new.loc[df_new["fitness_function"] == "I.S.C."]["hypervolume values"], 
        yerr=df_new.loc[df_new["fitness_function"] == "I.S.C."]['hypervolume std'], fmt='none', c= 'black', capsize = 2)
    plt.errorbar(x = br3, y = df_new.loc[df_new["fitness_function"] == "I.S.T."]["hypervolume values"], 
        yerr=df_new.loc[df_new["fitness_function"] == "I.S.T."]['hypervolume std'], fmt='none', c= 'black', capsize = 2)
    plt.errorbar(x = br4, y = df_new.loc[df_new["fitness_function"] == "I.S.C.T."]["hypervolume values"], 
        yerr=df_new.loc[df_new["fitness_function"] == "I.S.C.T."]['hypervolume std'], fmt='none', c= 'black', capsize = 2)
    ...
    plt.xticks([r + barWidth for r in range(len(df_new.loc[df_new["fitness_function"] == "I.S.C.T."]))], ['HV influence seed size', 'HV influence seed size \ntime', 'HV influence seed size \n#communities' ])
