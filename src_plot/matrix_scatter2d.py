...
'''
File provided by Professor Giovanni Iacca.
The file accepts as input only .csv files generated by graph_influence.py.

The script allows to visualize the 3 objective functions in separate plots and in correlated plots.

Inserting two csv it is possible to visualize a comparison between the two chosen files.
