...
if Question == ("RA"):
    ...
    filename = "/Users/elia/Desktop/Influence-Maximization/graphs/Amazon0302.txt"
...
if Question == ("Y"):      
    ...
    plt.savefig("plot_graph/original-"+name+".png", dpi=300)
    plt.cla()
...
if Question == ("Y"):      
    ...
    nx.draw(g, position,  edgecolors='black',node_color='white',arrowsize=1,node_size=20,linewidths=1, edge_color="#C0C0C0", width=0.5)
    plt.savefig("plot_graph/SBM-"+name+".png", dpi=300)
    plt.cla()
...
if Question == ("Y"):      
    ...
    nx.draw_networkx_nodes(g, pos, items.keys(), node_size=40,
                        cmap=cmap, node_color=list(items.values()))
    nx.draw_networkx_edges(g, pos, alpha=0.5,edge_color="#C0C0C0")
    plt.savefig("plot_graph/SBM-community"+name+".png", dpi=300)
