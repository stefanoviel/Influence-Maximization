...
df8 = pd.read_csv("pgp_TRUE-8.0-k30-p0.2-IC-NEW_3_OBJ-time.csv", sep=",")
...
df4 = pd.read_csv("pgp_TRUE-4.0-k60-p0.2-IC-NEW_3_OBJ-time.csv", sep=",")
...
df2 = pd.read_csv("pgp_TRUE-2.0-k116-p0.2-IC-NEW_3_OBJ-time.csv", sep=",")
p2 = {}
p2["avg"] = np.array([])
p2["std"] = np.array([])
...
df0 = pd.read_csv("pgp-k267-p0.2-IC-NEW_3_OBJ-time.csv",sep=',')
p_original = {}
