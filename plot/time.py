...
df8 = pd.read_csv("pgp_8-k25-p0-WC-NEW_3_OBJ-time.csv", sep=",")
...
df4 = pd.read_csv("pgp_4-k52-p0-WC-NEW_3_OBJ-time.csv", sep=",")
...
df2 = pd.read_csv("pgp_2-k107-p0-WC-NEW_3_OBJ-time.csv", sep=",")
p2 = {}
p2["avg"] = np.array([])
p2["std"] = np.array([])
