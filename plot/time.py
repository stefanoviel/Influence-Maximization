...
df8 = pd.read_csv("fb_politician_TRUE-8.0-k17-p0.01-IC-NEW_3_OBJ-time.csv", sep=",")
...
df4 = pd.read_csv("fb_politician_TRUE-4.0-k35-p0.01-IC-NEW_3_OBJ-time.csv", sep=",")
...
df2 = pd.read_csv("fb_politician_TRUE-2.0-k70-p0.01-IC-NEW_3_OBJ-time.csv", sep=",")
p2 = {}
p2["avg"] = np.array([])
p2["std"] = np.array([])
...
df0 = pd.read_csv("fb_politician-k147-p0.01-IC-NEW_3_OBJ-time.csv",sep=',')
p_original = {}
